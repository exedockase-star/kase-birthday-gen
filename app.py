...
if st.button("Generate Birthday Card"):
    if uploaded_file and name and desig:
        ...
        # Paste Photo and Template
        canvas.paste(rounded_photo, (px, py), rounded_photo)
        
        # Add Text (Bold Name, Regular Designation)
        draw = ImageDraw.Draw(canvas)
        font_bold = ImageFont.truetype("NotoSerifCondensed-Bold.ttf", 32)
        font_reg = ImageFont.truetype("NotoSerifCondensed-Regular.ttf", 22)
